    ...
    def _structured_answer(
        ...
        *,
        ...
        if category == "성폭력":
            ...
            elif self._is_photo_upload_case(question):
                # 피해자가 상대방의 사진 게시 피해를 받은 경우 → 양면 관점 답변으로 즉시 반환
                return self._photo_upload_victim_answer(question, case_frame, sources, is_general)
            else:
...
※ 이 답변은 법률정보 제공을 위한 일반 안내입니다. 긴급한 위험이 있거나 기한이 임박한 경우 전문기관 또는 변호사 상담을 우선 이용하세요."""
    ...
    def _photo_upload_victim_answer(
        self,
        question: str,
        case_frame: Any | None,
        sources: str,
        ...
        """피해자가 상대방의 사진 게시 피해를 받은 경우의 양면 관점 답변."""
        general_note = "제공된 정보가 부족하여 일반적인 기준 중심으로 안내합니다.\n\n" if is_general else ""
        is_swimsuit = any(k in question for k in ("수영복", "비키니", "수영"))

        if is_swimsuit:
            legal_judgment = (
                "수영복 사진은 통상적인 법적 기준상 '음란물'에 해당하기 어렵습니다. "
                "음란물은 성욕을 자극하고 성적 수치심을 일으키는 노골적 표현을 요건으로 하므로, "
                "일반적인 수영복 착용 사진은 이 기준을 충족하지 않는 경우가 대부분입니다. "
                "다만 동의 없이 게시했다면 민법상 초상권·사생활 침해(손해배상 청구 가능)와 "
                "정보통신망법상 사생활 침해(제44조의7) 문제는 별도로 성립할 수 있습니다. "
                "사진이 성적 수치심을 강하게 유발하는 경우에는 성폭력처벌법 쟁점도 검토할 수 있습니다."
            )
        else:
            legal_judgment = (
                "동의 없이 타인의 사진·영상을 게시하면 민법상 초상권·사생활 침해와 "
                "정보통신망법상 사생활 침해(제44조의7) 문제가 될 수 있습니다. "
                "사진의 성적 성격이 강하거나 피해자가 성적 수치심을 느끼는 경우에는 "
                "성폭력처벌법상 쟁점도 함께 검토할 수 있습니다. "
                "처벌 가능성은 사진 내용, 동의 여부, 게시 목적에 따라 달라집니다."
            )
        ...
        text = (
            ...
            "1. 상황 정리\n"
            f"{general_note}"
            "상대방(남자친구 등)이 질문자의 사진·영상을 SNS·메신저 등에 게시·공유한 사안입니다. "
            "피해자(질문자)와 게시자(상대방) 각각의 법적 입장이 다르므로 양 관점을 함께 안내합니다.\n\n"
            "2. 법적 판단 — 음란물 유포 성립 기준\n"
            f"{legal_judgment}\n\n"
            "[피해자(질문자) 관점]\n\n"
            "3. 신고 가능 여부와 확인할 사항\n\n"
            "사전 동의를 한 적이 있는지 → 동의 없이 게시됐다면 초상권·사생활 침해로 신고·손해배상 청구가 가능합니다.\n\n"
            "사진이 성적 수치심을 유발하는 수준인지 → 수준에 따라 형사 고소 가능 범위가 달라집니다.\n\n"
            "게시물이 아직 남아 있는지 → 즉시 캡처해 증거를 확보하세요.\n\n"
            "4. 지금 할 일 (피해자)\n\n"
            "- 게시된 사진과 URL·계정 정보를 캡처해 증거로 보존하세요.\n"
            "- SNS 플랫폼에 '동의 없는 사진 게시·사생활 침해'로 신고 및 삭제 요청하세요.\n"
            "- 상대방에게 즉시 삭제 요구를 카카오톡·문자로 기록을 남겨 전달하세요.\n"
            "- 형사 고소나 손해배상을 원한다면 법률구조공단(132) 또는 사이버수사대(182)에 상담하세요.\n\n"
            "[게시자(상대방) 관점]\n\n"
            "5. 법적 책임 발생 조건\n\n"
            "책임이 발생하는 경우 → 사진 게시에 대한 사전 동의 없이 올린 경우 민사 손해배상 책임이 발생할 수 있습니다.\n\n"
            "책임이 가중되는 경우 → 삭제 요구를 무시하고 계속 게시하거나 사진의 성적 성격이 강한 경우입니다.\n\n"
            "책임이 경감되는 경우 → 게시 전 명시적 동의를 받은 증거(카카오톡 등)가 있거나 공개 장소의 일반적 사진인 경우입니다.\n\n"
            "6. 지금 할 일 (게시자)\n\n"
            "- 피해자의 삭제 요구가 있다면 즉시 게시물을 삭제하세요.\n"
            "- 동의를 받은 대화 내용이 있다면 캡처해 보관하세요.\n"
            "- 분쟁이 심화될 경우 형사 전문 변호사 상담을 받으세요.\n\n"
            "7. 도움을 받을 수 있는 곳\n\n"
            "- 경찰 사이버수사대: 182\n"
            "- 디지털성범죄피해자지원센터(디성센터): 02-735-8994\n"
            "- 대한법률구조공단: 132 (무료 법률상담)\n"
            "- 여성긴급전화: 1366\n\n"
            "※ 이 답변은 제공된 사실관계만을 바탕으로 한 일반 안내입니다.\n\n"
            "[참고한 근거]\n\n"
            f"{source_block}\n\n"
            "※ 이 답변은 법률정보 제공을 위한 일반 안내입니다. "
            "긴급한 위험이 있거나 기한이 임박한 경우 전문기관 또는 변호사 상담을 우선 이용하세요."
        )
        return self._fix_known_contacts(re.sub(r"\n{3,}", "\n\n", text).strip())
