...
※ 이 답변은 법률정보 제공을 위한 일반 안내입니다. 긴급한 위험이 있거나 기한이 임박한 경우 전문기관 또는 변호사 상담을 우선 이용하세요."""
    ...
    def _photo_upload_victim_answer(
        ...
        """피해자가 상대방의 사진 게시 피해를 받은 경우의 단독 피해자 관점 답변 (표준 5섹션)."""
        general_note = "제공된 정보가 부족하여 일반적인 기준 중심으로 안내합니다.\n\n" if is_general else ""
        is_swimsuit = any(k in question for k in ("수영복", "비키니", "수영"))

        if is_swimsuit:
            situation = (
                "상대방(남자친구 등)이 질문자의 수영복 사진을 동의 없이 SNS에 게시한 사안입니다. "
                "수영복 사진이 법적으로 음란물에 해당하는지 여부와 신고·대응 방법을 검토합니다."
            )
            legal_judgment = (
                "수영복 사진은 통상적인 법적 기준상 음란물에 해당하기 어렵습니다. "
                "음란물은 성욕을 자극하고 수치심을 일으키는 노골적 표현을 요건으로 하므로, "
                "일반적인 수영복 착용 사진은 이 기준을 충족하지 않는 경우가 대부분입니다. "
                "다만 동의 없이 게시됐다면 민법상 초상권·사생활 침해로 손해배상을 청구하거나 "
                "정보통신망법상 사생활 침해(제44조의7)를 근거로 신고할 수 있습니다. "
                "사진이 성적 수치심을 강하게 유발하는 경우에는 성폭력처벌법상 쟁점도 추가로 검토할 수 있습니다."
            )
        else:
            situation = (
                "상대방이 질문자의 사진·영상을 동의 없이 SNS·메신저 등에 게시·공유한 사안입니다. "
                "신고 가능 여부와 피해자로서의 대응 방법을 검토합니다."
            )
            legal_judgment = (
                "동의 없이 타인의 사진·영상을 게시하면 민법상 초상권·사생활 침해와 "
                "정보통신망법상 사생활 침해(제44조의7) 문제가 될 수 있습니다. "
                "사진의 성적 성격이 강하거나 성적 수치심을 유발하는 수준이라면 "
                "성폭력처벌법상 쟁점도 함께 검토할 수 있습니다."
            )

        check_items = [
            ("사진 게시에 사전 동의를 한 적이 있는지", "동의 없이 게시됐다면 초상권·사생활 침해로 신고·손해배상 청구가 가능합니다."),
            ("사진이 성적 수치심을 유발하는 수준인지", "수준에 따라 형사 고소 가능 범위가 달라집니다."),
            ("게시물이 아직 남아 있는지", "지금 바로 캡처해 증거를 확보하세요."),
            ("상대방이 삭제 요구를 거부하는지", "거부한다면 사이버수사대 신고나 민사 가처분 신청을 검토할 수 있습니다."),
        ]
        actions = [
            "게시된 사진과 URL·계정 정보를 캡처해 증거로 보존하세요.",
            "SNS 플랫폼에 동의 없는 사진 게시·사생활 침해로 신고 및 삭제 요청하세요.",
